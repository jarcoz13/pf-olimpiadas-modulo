...
/* Created on:     7/10/2021 4:49:43 a. m.                      */
/*==============================================================*/
/*==============================================================*/
/* Table: AREA                                                  */
/*==============================================================*/
...
create table COMIDEPOR (
   IDCOMIDEPOR          INT4                 not null,
   CODPERSONA           VARCHAR(4)           not null,
   IDDEPORTE            VARCHAR(5)           not null,
   constraint PK_COMIDEPOR primary key (IDCOMIDEPOR)
);
...
create table COMISARIODEPORTES (
   IDCOMISARIODEPORTES  INT4                 not null,
   CODPERSONA           VARCHAR(4)           not null,
   IDDEPORTE2           VARCHAR(5)           not null,
   constraint PK_COMISARIODEPORTES primary key (IDCOMISARIODEPORTES)
);

/*==============================================================*/
/* Index: COMISARIODEPORTES_PK                                  */
/*==============================================================*/
create unique index COMISARIODEPORTES_PK on COMISARIODEPORTES (
IDCOMISARIODEPORTES
);
...
create table EQUIPODEPORTE (
   IDEQUIPODEPORTE      INT4                 not null,
   IDEQUIPO             VARCHAR(3)           not null,
   IDDEPORTE            VARCHAR(5)           not null,
   constraint PK_EQUIPODEPORTE primary key (IDEQUIPODEPORTE)
);
